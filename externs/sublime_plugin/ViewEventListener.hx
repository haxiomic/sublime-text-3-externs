...
@:pythonImport("sublime_plugin", "ViewEventListener") extern class ViewEventListener {
	...
	**/
	function on_query_completions(prefix:String, locations:Array<Int>):Null<haxe.extern.EitherType<Array<Any>, python.Tuple<Any>>>;
	/**
	...
	**/
	function on_text_command(command_name:String, args:python.Dict<String, Any>):python.Tuple.Tuple2<String, python.Dict<String, Any>>;
	/**
		Called after a text command has been executed.
	**/
	function on_post_text_command(command_name:String, args:python.Dict<String, Any>):Void;
}