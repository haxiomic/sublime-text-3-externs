...
@:pythonImport("sublime_plugin", "EventListener") extern class EventListener {
	...
	**/
	function on_query_completions(view:sublime.View, prefix:String, locations:python.Tuple.Tuple3<String, String, python.Tuple.Tuple2<Int, Int>>):Null<haxe.extern.EitherType<List<Any>, python.Tuple<Any>>>;
	/**
