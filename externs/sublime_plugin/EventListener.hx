...
@:pythonImport("sublime_plugin", "EventListener") extern class EventListener {
	...
	**/
	function on_hover(view:sublime.View, point:Int, hover_zone:Int):Void;
	/**
	...
	**/
	function on_query_context(view:sublime.View, key:String, _operator:Int, operand:Any, match_all:Bool):Null<Bool>;
	/**
	...
	**/
	function on_query_completions(view:sublime.View, prefix:String, locations:Array<Int>):Null<haxe.extern.EitherType<Array<Any>, python.Tuple<Any>>>;
	/**
